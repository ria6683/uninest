...
# 1. UPDATED BASE.HTML (New Font + Professional Icon Logo)
base_html = """<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>UniNest | Student Living</title>
...
<body class="d-flex flex-column min-vh-100">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary py-3"> 
        <div class="container">
            <a class="navbar-brand" href="/" style="font-family: 'Montserrat', sans-serif; font-size: 1.8rem; letter-spacing: -1px;">
                <i class="bi bi-houses-fill"></i> UniNest
            </a>
    ...
    <footer class="bg-dark text-white text-center py-4 mt-5">
        <div class="container">
            <h5 style="font-family: 'Montserrat', sans-serif;">UniNest</h5>
            <p class="mb-0 text-muted small">© 2025 UniNest Student Living.</p>
        </div>
    </footer>
...
# 2. UPDATED HOME.HTML (New Cozy Background Image)
# Using a specific high-quality interior design image instead of a random one
...
<section class="text-white text-center py-5" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80') no-repeat center center; background-size: cover; padding-top: 100px !important; padding-bottom: 100px !important;">
    <div class="container">
        <h1 class="display-3 fw-bold mb-3" style="font-family: 'Montserrat', sans-serif;">Find Your Comfort Zone</h1>
        <p class="lead fs-4 mb-5">Affordable rooms and student accommodation in Melbourne.</p>
...
with open('templates/base.html', 'w') as f:
    f.write(base_html)
    print("Updated: templates/base.html (New Logo Font)")

with open('templates/core/home.html', 'w') as f:
    f.write(home_html)
    print("Updated: templates/core/home.html (New Background Image)")
